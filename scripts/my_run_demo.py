...
if __name__=="__main__":
  ...
  parser.add_argument('--ckpt_dir', default=f'{code_dir}/../pretrained_models/23-51-11/23-51-11.pth', type=str, help='pretrained model path')
  parser.add_argument('--out_dir', default=f"{code_dir}/../assets/desk", type=str, help='the directory to save results')
